...
import com.vfstr.cse.databinding.ActivityCreateEventBinding;
...
public class CreateEventActivity extends BaseActivity {
    ...
    private void populateForm(com.vfstr.cse.core.network.models.Event event) {
    ...
    private void setupSpinner() {
        List<String> eventTypes = com.vfstr.cse.core.network.ConfigRepository.getInstance(this).getEventTypes();
