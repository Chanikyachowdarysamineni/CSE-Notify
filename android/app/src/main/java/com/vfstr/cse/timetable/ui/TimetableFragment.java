package com.vfstr.cse.timetable.ui;
...
import com.vfstr.cse.core.network.models.Timetable;
import com.vfstr.cse.core.utils.Constants;
import com.vfstr.cse.core.utils.FileUtils;
import com.vfstr.cse.databinding.FragmentTimetableBinding;
import com.vfstr.cse.profile.data.ProfileRepository;
import com.vfstr.cse.timetable.ui.adapter.TimetableDayAdapter;
import com.vfstr.cse.timetable.viewmodel.TimetableViewModel;
...
public class TimetableFragment extends BaseFragment {
    ...
    private void loadStudentProfileThenFetch() {
        ...
        profileRepo.getProfile().observe(getViewLifecycleOwner(), response -> {
            if (response != null && response.status == com.vfstr.cse.auth.data.AuthRepository.Resource.Status.SUCCESS && response.data != null) {
        ...
        viewModel.getOfflineTimetableForDay(ayId, secId, currentSelectedDay)
                .observe(getViewLifecycleOwner(), entities -> {
                    if (entities != null && entities.size() > 0) {
                        ...
                        for (com.vfstr.cse.core.database.entity.TimetableEntity ent : entities) {
    ...
    private Timetable mapEntityToModel(com.vfstr.cse.core.database.entity.TimetableEntity ent) {
