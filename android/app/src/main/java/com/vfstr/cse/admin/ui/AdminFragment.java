package com.vfstr.cse.admin.ui;
...
import com.vfstr.cse.databinding.FragmentAdminBinding;
...
public class AdminFragment extends BaseFragment {
    ...
    private void setupListeners() {
        ...
        binding.cardManageAcademic.setOnClickListener(v -> {
            ...
            android.content.Intent intent = new android.content.Intent(requireContext(), com.vfstr.cse.academic.ui.AcademicYearActivity.class);
            startActivity(intent);
        });

        binding.cardManageTimetable.setOnClickListener(v -> {
            android.content.Intent intent = new android.content.Intent(requireContext(), com.vfstr.cse.timetable.ui.TimetableManagementActivity.class);
            startActivity(intent);
        });
