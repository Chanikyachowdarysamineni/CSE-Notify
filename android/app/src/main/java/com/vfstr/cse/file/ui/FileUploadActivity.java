...
import com.vfstr.cse.databinding.ActivityFileUploadBinding;
import com.vfstr.cse.file.viewmodel.FileViewModel;
...
public class FileUploadActivity extends BaseActivity {
    ...
    private void setupSpinner() {
        List<String> fileCategories = com.vfstr.cse.core.network.ConfigRepository.getInstance(this).getFileCategories();
