package com.vfstr.cse.event.ui;
...
import com.vfstr.cse.core.network.models.Event;
import com.vfstr.cse.core.utils.Constants;
import com.vfstr.cse.databinding.FragmentEventListBinding;
import com.vfstr.cse.event.ui.adapter.EventAdapter;
import com.vfstr.cse.event.viewmodel.EventViewModel;
...
public class EventListFragment extends BaseFragment {
    ...
    private void loadOfflineEvents() {
        viewModel.getOfflineEvents().observe(getViewLifecycleOwner(), entities -> {
            if (entities != null && entities.size() > 0) {
                ...
                for (com.vfstr.cse.core.database.entity.EventEntity ent : entities) {
    ...
    private Event mapEntityToModel(com.vfstr.cse.core.database.entity.EventEntity ent) {
        return new Event() {
            @Override
