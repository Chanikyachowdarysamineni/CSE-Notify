...
import com.vfstr.cse.databinding.ActivityCreateNotificationBinding;
...
public class CreateNotificationActivity extends BaseActivity {
    ...
    private void populateForm(com.vfstr.cse.core.network.models.Notification n) {
    ...
    private void setupSpinners() {
        List<String> categories = com.vfstr.cse.core.network.ConfigRepository.getInstance(this).getNotificationCategories();
