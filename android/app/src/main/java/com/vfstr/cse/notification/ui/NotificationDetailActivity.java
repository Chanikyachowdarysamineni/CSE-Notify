...
import com.vfstr.cse.databinding.ActivityNotificationDetailBinding;
...
public class NotificationDetailActivity extends BaseActivity {
    ...
    private void markAsRead() {
        ...
        androidx.work.Data inputData = new androidx.work.Data.Builder()
                .putString(com.vfstr.cse.core.fcm.NotificationReadWorker.KEY_NOTIFICATION_ID, notificationId)
                .build();

        androidx.work.OneTimeWorkRequest readWork = new androidx.work.OneTimeWorkRequest.Builder(com.vfstr.cse.core.fcm.NotificationReadWorker.class)
