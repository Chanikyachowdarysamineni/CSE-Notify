...
import com.vfstr.cse.databinding.ActivityGalleryUploadBinding;
...
public class GalleryUploadActivity extends BaseActivity {
    ...
    private void setupSpinner() {
        List<String> galleryCategories = com.vfstr.cse.core.network.ConfigRepository.getInstance(this).getGalleryCategories();
